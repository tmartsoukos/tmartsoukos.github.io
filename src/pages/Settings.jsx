      ...
      <div className="flex flex-col gap-4 px-4 py-4">
        ...
        <Card>
          ...
          <p className="text-sm text-muted">
            Όποιος συνδεθεί στην εφαρμογή βλέπει και αλλάζει τα ίδια δεδομένα. Για να δουλέψει
            μαζί σου ο βοηθός προπονητή, αρκεί να φτιάξει λογαριασμό και να συνδεθεί — οι αλλαγές
            εμφανίζονται και στους δύο σε πραγματικό χρόνο.
          </p>
        </Card>
